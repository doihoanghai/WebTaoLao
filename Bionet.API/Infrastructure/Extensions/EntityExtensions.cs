...
namespace Bionet.API.Infrastructure.Extensions
{
    public static class EntityExtensions
    {
        ...
        public static void UpdateUser(this ApplicationUser appUser, ApplicationUserViewModel appUserViewModel, string action = "add")
        {
            ...
            if (appUserViewModel.Password != null)
        ...
        public static void UpdateGoiDichVu(this DanhMucGoiDichVuChung goidvchung,DanhMucGoiDichVuChungViewModel goidvchungVM)
        {
            goidvchung.RowIDGoiDichVuChung = goidvchungVM.RowIDGoiDichVuChung;
            goidvchung.IDGoiDichVuChung = goidvchungVM.IDGoiDichVuChung;
            goidvchung.TenGoiDichVuChung = goidvchungVM.TenGoiDichVuChung;
            goidvchung.ChietKhau = goidvchungVM.ChietKhau;
            goidvchung.DonGia = goidvchungVM.DonGia;
        }
